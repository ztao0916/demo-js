/**
 * JSON Schema 到 JavaScript 字段映射转换器
...
class SchemaToFieldMapper {
  ...
  processArrayField(fieldName, fieldSchema, parentRequired) {
    ...
    if (parentRequired || fieldSchema.minItems > 0) {
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = SchemaToFieldMapper;
...
// 导出便捷函数
if (typeof module !== 'undefined' && module.exports) {
  module.exports.convertSchemaToFields = convertSchemaToFields;
  module.exports.convertSchemaToBeFunction = convertSchemaToBeFunction;
}
